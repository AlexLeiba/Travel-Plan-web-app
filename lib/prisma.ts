import { PrismaClient } from './generated/prisma/client'; // the generated folder is created after the command: npx prisma generate (Generate is used to have Client Prisma up to date with the Prisma Schema)
