          ...
          <div className="flex md:flex-row flex-col gap-2 ">
            <div className="flex gap-2">
              ...
              <Link
                ...
                className="font-normal md:size-[110px] h-[110px] w-full p-1 bg-yellow-800 hover:bg-yellow-700 flex flex-col justify-between relative hover:scale-105 scale-100 transition-all"
              >
                <div className=" flex justify-center items-center h-full ">
              ...
              <Link
                ...
                className="font-normal md:size-[110px] h-[110px] w-full p-1 bg-green-800 hover:bg-green-700 flex flex-col justify-between relative hover:scale-105 scale-100 transition-all"
              >
                <div className=" flex justify-center items-center h-full ">
            ...
            <Link href={"/my-trips?favorite=true"}>
              <div className="font-normal md:size-[110px] h-[110px] w-full p-1 bg-purple-800 hover:bg-purple-700  flex flex-col justify-between relative hover:scale-105 scale-100 transition-all">
                <div className=" flex justify-center items-center h-full ">
