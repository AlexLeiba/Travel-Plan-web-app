  ...
  return (
    <div className="dark:text-white">
      ...
      <div className=" flex gap-2 ">
        <div className="font-normal size-[80px] p-1 bg-gray-700 flex flex-col justify-between relative">
        ...
        <div className="font-normal size-[80px] p-1 bg-gray-600 flex flex-col justify-between relative">
          <div className=" flex justify-center items-center h-full">
            <p className="text-4xl line-clamp-1">
        ...
        <div className="font-normal size-[80px] p-1 bg-gray-500 flex flex-col justify-between relative">
          <div className=" flex justify-center items-center h-full">
            <p className="text-4xl line-clamp-1">
        ...
        <Link href={"/my-trips/new-trip"}>
          <div className="font-normal h-[80px] w-[200px] p-1 scale-100 hover:scale-105 hover:bg-green-600 transition-all bg-green-800 flex flex-col justify-between relative">
            <div className=" flex justify-center items-center h-full">
